...
Scenario
An online store wants to show customers whether a product is available before they place an order. 
The inventory system stores the number of currently available units. Your job is to convert that number 
into a meaningful status message.
...
Think carefully about boundary values 
...
getStockStatus(3);// "Almost Sold Out"
getStockStatus(12);// "Available"
getStockStatus(50);// "In Stock"
